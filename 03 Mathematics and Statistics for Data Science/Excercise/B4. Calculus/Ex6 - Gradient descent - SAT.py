...
print(u'Dự đoán High school GPA 2.3 có University GPA: %.2f' % univ_GPA_new[0])
print(u'Dự đoán High school GPA 2.8 có University GPA: %.2f' % univ_GPA_new[1])
print(u'Dự đoán High school GPA 3.3 có University GPA: %.2f' % univ_GPA_new[2])
print(u'Dự đoán High school GPA 3.8 có University GPA: %.2f' % univ_GPA_new[3])
